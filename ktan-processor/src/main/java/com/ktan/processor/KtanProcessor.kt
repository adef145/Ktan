...
import com.ktan.flow.annotations.SharedFlowExtra
import com.ktan.flow.annotations.StateFlowExtra
    ...
    private inner class ExtrasKClassVisitor(
        ...
        override fun visitClassDeclaration(
            ...
            properties.filter { it.validate() }.forEach {
                ...
                val isStateFlowExtra =
                    !liveDataOption && it.annotations.isAnnotationPresent(StateFlowExtra::class.java.simpleName)
                val isSharedFlowExtra =
                    !liveDataOption && it.annotations.isAnnotationPresent(SharedFlowExtra::class.java.simpleName)
                val isFlowExtra = isSharedFlowExtra || isStateFlowExtra
                ...
                if (isFlowExtra && !hasImportFlowExtraExt) {
                    importDependencies.append(
                        """
                        |
                        |import com.ktan.flow.stateFlowExtraOf
                        |import com.ktan.flow.sharedFlowExtraOf
                        |import com.ktan.flow.mutableStateFlowExtraOf
                        |import com.ktan.flow.mutableSharedFlowExtraOf
                        |import com.ktan.flow.requiredStateFlowExtraOf
                        |import com.ktan.flow.requiredSharedFlowExtraOf
                        |import com.ktan.flow.requiredMutableStateFlowExtraOf
                        |import com.ktan.flow.requiredMutableSharedFlowExtraOf
                        """.trimMargin()
                    )
                ...
                if (isStateFlowExtra) {
                    delegatedPropertyBinding = "stateFlow${
                        delegatedPropertyBinding.replaceFirstChar { first ->
                            first.uppercase()
                        }
                    }"
                ...
                if (isSharedFlowExtra) {
                    delegatedPropertyBinding = "sharedFlow${
                        delegatedPropertyBinding.replaceFirstChar { first ->
                            first.uppercase()
                        }
                    }"
